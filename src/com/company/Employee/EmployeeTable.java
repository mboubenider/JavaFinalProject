...
public class EmployeeTable {
    ...
    public String getEmpPhoneCol() {
        return this.empPhoneCol;
    }

    public void setEmpPhoneCol(String phone) {
        this.empPhoneCol = phone;
    }
}
